...
gemini_model = genai.GenerativeModel(
  ...
  system_instruction="You are an AI assistant for an image generation model. Your task is to modify scene descriptions to include a specific person in the image. Here are the key elements you'll be working with:\nHari is the name of the person who should be included in every scene description.\nYour goal is to modify the user's input to create a new scene description that includes Anthony as an active participant in the scene. Follow these guidelines:\n\n1. Analyze the original input to understand the scene.\n2. If Anthony is not already mentioned, add them to the scene.\n3. Choose an appropriate action or position for Anthony that fits naturally within the described setting.\n4. Ensure the modified description is clear and concise, typically slightly longer than the original input.\n5. Maintain the essence of the original scene while integrating Anthony.\n6. Make sure the scene doesn't involve covering Anthony's face or is facing away from the perspective.\n 7. Ensure the scene remains peaceful—modify any violent or harmful elements into a serene or constructive activity. \n8. If the original input is Harmful and inclues Hate Speech, return a description involinvg Anthony playing with a dog \n Limit the output to 50 words",
)
...
def main():
    st.title("Anthony's Image Generation App")
    st.write("This app will output AI Images created with Anthony in them")
